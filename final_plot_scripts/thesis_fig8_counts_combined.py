...
def panel(ax, mw, mwe, cm, cme, rcm, rcme, ylabel, title):
    ax.errorbar(P, cm, yerr=cme, marker="s", ls="-", color=C_CM, capsize=3, elinewidth=1.0)
    ax.errorbar(P, rcm, yerr=rcme, marker="D", ls="-", color=C_RCM, capsize=3, elinewidth=1.0)
    ax.errorbar(P, mw, yerr=mwe, marker="o", ls="--", color=C_MW, capsize=3, elinewidth=1.0)
